...
class UserRouter:
    ...
    def create_user(self, request: Annotated[UserCreate, Form()], current_admin: User = Depends(get_current_active_admin)):
    ...
    def update_user(self, user_id: int, request: Annotated[UserUpdate, Form()], current_admin: User = Depends(get_current_active_admin)):
